...
if page=="تحلیل سهم":
    ...
    st.caption("مبنای محاسبه دلار آزاد است. میانگین هر نماد از تمام روزهای دارای داده در بازه ابتدای ۱۳۹۵ تا پایان ۱۴۰۴ محاسبه می‌شود و جدول از کوچک‌ترین نسبت به بزرگ‌ترین مرتب شده است.")
