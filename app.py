...
if page=="تحلیل سهم":
    ...
    st.caption("مبنای جدول دلار آزاد است. علاوه بر نسبت ارزش فعلی به میانگین ۱۳۹۵–۱۴۰۴، P/E دلاری بر مبنای میانگین سود ۵ ساله و حاصل‌ضرب این دو نسبت نیز نمایش داده می‌شود. جدول بر اساس نسبت اول از کوچک به بزرگ مرتب است.")
    ...
    # فقط نمادهایی که P/E دلاری ۵ ساله قابل محاسبه دارند وارد جدول شوند.
